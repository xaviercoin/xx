#############################################################################
# Makefile for building: xaviercoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Mar 30 16:47:56 2016
# Project:  XavierCoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile XavierCoin-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/XavierCoin/src/leveldb/libleveldb.a /tmp/XavierCoin/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: XavierCoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile XavierCoin-qt.pro
...
/tmp/XavierCoin/src/leveldb/libleveldb.a: FORCE
	cd /tmp/XavierCoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

build/build.h: FORCE
	cd /tmp/XavierCoin; /bin/sh share/genbuild.sh build/build.h
